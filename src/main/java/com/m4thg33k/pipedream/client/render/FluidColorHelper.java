...
public class FluidColorHelper {
    ...
    private static HashMap<String, Vec3d> colorMap = new HashMap<String, Vec3d>();
    ...
    protected static void createFluidColorMaps()
    {
    ...
    {
        saveGlTexture("test", post.getMap().getGlTextureId(), 0);
    }
}
